...
`adzuna_raw_YYYYMMDD_HHMMSS.json` — full JSON response from 5 paginated keyword searches across 76 API calls. 3,653 postings before deduplication.
...
Run `notebooks/01_data_collection.ipynb`. Requires an Adzuna API key set in `.env` at the project root.
